...
'this' will now become myObject and inherit all its properties upto its current scope. When invoked, 
outer func prints out "lovelace" when this.name and self.name are used. This is because self is used to refer
to 'this' which is the object itself. When the property name is invoked in inner func, this.name prints out undefined because
the outer func which was the execution context of 'this' has switched back to being a global object as the function's
lifecycle has ended. 
